...
//iki nokta diyerek bir üst dizine ulaştık
...
<a href="#${movie.id}">${movie.title}</a></h5>
      <p>${movie.overview}</p>    
       ...
       elements.movieListHeader.innerHTML=`${keyword} arasında ${data.total_results}`; elements.movieListContainer.classList.add("d-block"); elements.movieList.insertAdjacentHTML("beforeend",html);    
    });
