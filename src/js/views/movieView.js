...
//behavior:smooth diyerek en üste yavaşca gitmesini sağladık 

export const closeDetails=()=>{
    
    elements.moviDetailsContainer.classList.remove("d-block");
}
...
${genres}
    ...
    elements.moviDetailsContainer.classList.add("d-block");
    elements.moviDetails.innerHTML=html;
